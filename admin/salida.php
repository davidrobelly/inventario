                                        ...
                                        <?php $id= $fila->id_salida; ?>
                                             ...
                                             <td width="25%" class="hidden-print noprin">
                                                <center>
                                                  ...
                                                  <!-- <a  class="btn red btn-outline sbold "  title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold"  href='?admin=salida&eliminar&codigo='><i class=' fa fa-trash'></i></a> -->
