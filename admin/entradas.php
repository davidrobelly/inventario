...
//registrar el detalle del ingreso del producto
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-phone-l">Producto</th>
                                        ...
                                        <?php $id= $fila->id_ingreso; ?>
                                             ...
                                             <td width="25%" class="hidden-print noprin">
                                                <center>
                                                  ...
                                                  <!-- <a  class="btn red btn-outline sbold "  title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold"  href='?admin=entradas&eliminar&codigo='><i class=' fa fa-trash'></i></a> -->
