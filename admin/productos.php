   ...
   ";
         ...
         if($_FILES["fondo"]!=""){
                                      ...
                                      for($x=0; $x<count($_FILES["fondo"]["name"]); $x++)
                                      {
                                        ...
                                        $carpeta = "./producto/";
                                        //creo el producto con la sentencia sql
                                        if($size==0){
                                              $sql="INSERT INTO `service`
                                              (`name_service`, `price_service`, `tipo_producto`, `info_service`, `date_registro_pro`,`imagen`, `cod_proveedor`,`cod_empresa`) VALUES
                                               ('$nombress', '$precio', '$tipopro', '$descripcion', '$hoy','img-no.jpg', '$cod_proveedor', '$cod_empresa');";                 
                                             $bd->consulta($sql);
                              ...
                              //comprobamos el tamaño y tipo de formato del archivo de imagen
                                                           echo '   </div>';
                                          ...
                                          else if($size > 1024*1024)// 1024*1024 = 1 MB
                                          {
                                             ...
                                             $sql="INSERT INTO `service`
                                              (`name_service`, `price_service`, `tipo_producto`, `info_service`, `date_registro_pro`,`imagen`, `cod_proveedor`,`cod_empresa`) VALUES
                                               ('$nombress', '$precio', '$tipopro', '$descripcion', '$hoy','$name3', '$cod_proveedor', '$cod_empresa');";                 
                                             $bd->consulta($sql);
...
<!--registrar nueva entrada de producto -->
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-phone-l">Código Proveedor</th>
                                                <th class="min-phone-l">Código Empresa </th>
                                     ...
                                     $consulta="SELECT * FROM `service`ORDER by id_service DESC";
                                         $bd->consulta($consulta);
                                         //mostrando los productos en la tabla de catalogo de productos
                                      while ($fila=$bd->mostrar_registros()) { ?>
                                        <tr>    
                                        <?php $id= $fila->id_service; ?>

                                             <td  width="5%"><?php echo $fila->id_service; ?></td>
                                             <td  width="25%"><?php echo $fila->cod_proveedor; ?></td>
                                             <td  width="25%"><?php echo $fila->cod_empresa; ?></td>
                                             ...
                                             <td width="25%">
                                                <center>
                                                 ...
                                                 <!--  <a class="dt-button buttons-pdf cargar buttons-html5 btn blue btn-outline " data-toggle="modal"  title="Cargar imagen" href="#imagenprin1"><i class='fa fa-file-image-o'></i></a> -->
                                                  <!-- <a  class="btn red btn-outline sbold derecha"  title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold"  href='?admin=productos&eliminar&codigo='><i class=' fa fa-trash'></i></a> -->
                                                </center> 
                                             </td>
...
<!--modal guardar nuevo -->
<!-- lista de registrar neuvo producto -->
              ...
              <div id="login-overlay" class="modal-dialog">
                <div class="modal-content">
                     <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
                          ...
                          <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;"><h4><i class="fa fa-eye"></i>&nbsp; Registrar Nuevo producto.</h4></h2>
                      </div>
                            ...
                            <div class="table-scrollable">
                              <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                  <tr> 
                                    <td width="50%"><center>
                                        <input   required type="text" required name="cod_proveedor" required class="form-control">
                                    </td>
                                    <td width="50%"><center>
                                      <input class="form-control" required type="text" name="cod_empresa" />
                                    </td>
                                  </tr>
                                </tbody>
                                <thead>
        ...
        <div class="modal fade" id="productover" tabindex="-1" role="basic" aria-hidden="true">
              <div id="login-overlay" class="modal-dialog">
                <div class="modal-content">
                      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
                          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                          <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;"><h4><i class="fa fa-eye"></i>&nbsp; Consultar Producto.</h4></h2>
                      </div>
                  <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="productoedita" tabindex="-1" role="basic" aria-hidden="true">
              <div id="login-overlay" class="modal-dialog">
                <div class="modal-content">
                      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
                         <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                          <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;"><h4><i class="fa fa-edit"></i>&nbsp; Editar Productos.</h4></h2>
                      </div>
                  <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
                    <div class="modal-body">
         ...
         <div class="modal fade "    id="imagenprin" tabindex="-1" role="basic" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                 <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
                         <button  type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                          <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;"><h4><i class="fa fa-edit"></i>&nbsp; Editar Imagen de productos.</h4></h2>
                      </div>    
                                              <div id="miDiv"></div>
