<?php
            ...
            $apellidolog=$_SESSION['apellido'];
            $maillog=$_SESSION['correo']; 
            $idlog=$_SESSION['id'];
            $cilog=$_SESSION['ci'];
            $phonelog=$_SESSION['phone'];
...
$consultaadmin="SELECT * FROM empresa INNER JOIN administrador ON administrador.id_administrador = empresa.id_admin_id_empresa 
         ...
         if ($bd->numeroFilas() > 0 ) { 
            ...
            while ($admin=$bd->mostrar_registros()) {
                                 ...
                                 $nameadmin= "Fainca Group C.A."; 
                                  $diradmin= "CC. Alban Borja - Bloque J/Local 10"; 
                                  $rifadmin= "123456789";  
                                  $logoadmin= "logo_fainca.jpg";  
                                  $celadmin= "042-999999";  
  }
