            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="?admin=principal1">
                        <img src="./img/logo_fainca.jpg" alt="logo" class="logo-default" /> </a>
                             ...
                             <li class="nav-item start ">
                                ...
                                <li class="nav-item start ">
                                    <a href="#" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">Kardex de Ingresos/Salidas</span>
                                        <span class="selected"></span>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item start ">
                                            <a href="?admin=entradas" class="nav-link ">
                                                ...
                                                <span class="title">Ingresos de Productos</span>
                                         ...
                                         <li class="nav-item start ">
                                            <a href="?admin=salida" class="nav-link ">
                                                <i class="fa fa-search-plus"></i>
                                                <span class="title">Salidas de Productos</span>
                                    ...
                                    <ul class="sub-menu">
                                          ...
                                          <li class="nav-item start ">
                                            <a href="?admin=proveedores" class="nav-link ">
                                                <i class="fa fa-search-plus"></i>
                                                <span class="title">Ingresos de Proveedor </span>
                                            </a>
                                        </li>
